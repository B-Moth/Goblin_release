...
Platform installation details:
  ...
  - macOS   : Installs Goblin.app and creates launcher scripts
...
def _install_macos(exe: Path) -> None:
    ...
    browser_launcher.write_text(f'#!/bin/bash\n"{dest}/Contents/MacOS/Goblin"\n', encoding="utf-8")
    ...
    print(f"✓ Goblin.app installed to {dest}")
    print(f"✓ Launcher scripts in {launcher_dir}")
    print("  Double-click the launcher or drag Goblin.app to the Dock.")
